...
urlpatterns = [
    ...
    #re_path(r'^$', views.home, name='home'), Old URL pattern before we changed home view to use GCBV
    re_path(r'^$', views.BoardListView.as_view(), name='home'), #new home page URL pattern using GCBV
